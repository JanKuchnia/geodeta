...
## Corpus Check
- 237 files · ~226,569 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5827 nodes · 5891 edges · 414 communities (399 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `441db909`
...
1. `files` - 222 edges
2. `components` - 219 edges
3. `skills` - 62 edges
4. `skills` - 42 edges
5. `5. Re-render Optimization` - 26 edges
6. `7. JavaScript Performance` - 26 edges
7. `agents` - 21 edges
8. `6. Rendering Performance` - 20 edges
9. `ToolkitRegressionTests` - 18 edges
10. `🧠 DEEP DESIGN THINKING (MANDATORY - BEFORE ANY DESIGN)` - 17 edges

## Surprising Connections (you probably didn't know these)
- `validate_manifest()` --calls--> `version_satisfies()`  [INFERRED]
  .agents/scripts/validate_kit.py → .agents/scripts/component_registry.py
- `main()` --calls--> `locate_toolkit_root()`  [INFERRED]
  .agents/scripts/checklist.py → .agents/scripts/validation_runner.py
- `main()` --calls--> `execute_suite()`  [INFERRED]
  .agents/scripts/checklist.py → .agents/scripts/validation_runner.py
- `main()` --calls--> `print_summary()`  [INFERRED]
  .agents/scripts/checklist.py → .agents/scripts/validation_runner.py
- `main()` --calls--> `write_report()`  [INFERRED]
  .agents/scripts/checklist.py → .agents/scripts/validation_runner.py

## Communities (414 total, 15 thin omitted)
...
Cohesion: 0.01
Nodes (221): files, agent/backend-specialist.md, agent/code-archaeologist.md, agent/database-architect.md, agent/debugger.md, agent/devops-engineer.md, agent/documentation-writer.md, agent/explorer-agent.md (+213 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (219): components, agent/backend-specialist.md, agent/code-archaeologist.md, agent/database-architect.md, agent/debugger.md, agent/devops-engineer.md, agent/documentation-writer.md, agent/explorer-agent.md (+211 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (51): add(), checkDiscovery(), checkHooks(), checkMcp(), checkOrchestration(), checkPlugin(), checkValidation(), diagnose() (+43 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (48): 1. Blast Radius Analysis (Primary Use), 2. Risk-Scored Change Analysis, 3. Dead Code Detection, 4. Refactoring Preview, 5. Architecture Visualization, 6. Wiki Generation, Alternatives Comparison, Best Practices (+40 more)
...
Cohesion: 0.04
Nodes (47): 10. Decision Checklist, 1. Framework Selection, 2. Runtime Considerations, 3. Architecture Principles, 4. Error Handling Principles, 5. Async Patterns Principles, 6. Validation Principles, 7. Security Principles (+39 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (45): additionalProperties, $ref, type, additionalProperties, type, additionalProperties, properties, required (+37 more)
...
Cohesion: 0.05
Nodes (43): additionalProperties, minLength, type, $defs, hook, type, additionalProperties, properties (+35 more)
...
Cohesion: 0.11
Nodes (37): build_lock(), build_manifest(), canonical_json(), compatible_range(), component_files(), extract_frontmatter(), _fallback_frontmatter(), is_semver() (+29 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (39): AG Kit Architecture, 🤖 Agents (20), Antigravity runtime architecture, Antigravity runtime utilities, Architecture & Planning, Backend & API, Cloud & Infrastructure, code:bash (python .agents/scripts/generate_manifest.py --check) (+31 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (39): ⛔ AI MOBILE ANTI-PATTERNS (BANNED LIST), Animation Performance, Architecture Sins, Before Every Screen, Before Release, Before Starting ANY Mobile Project, 📝 CHECKPOINT (MANDATORY Before Any Mobile Work), code:block1 (UNIFY (same on both)          DIVERGE (platform-specific)) (+31 more)
...
Cohesion: 0.06
Nodes (31): path, priority, trigger, version, path, priority, trigger, version (+23 more)
...
Cohesion: 0.07
Nodes (28): agents, database-architect, explorer-agent, product-manager, contracts, antigravityRuntime, componentApi, memorySchema (+20 more)
...
Cohesion: 0.07
Nodes (28): allowedTools, path, scripts, version, allowedTools, path, scripts, version (+20 more)
...
Cohesion: 0.07
Nodes (27): Anti-Patterns, Best Practices, code:block1 (User Request), code:block2 (❌ WRONG: "Based on your findings, fix the bug"), code:block3 (Investigate [specific question] in [file/directory scope].), code:block4 (Modify [specific file(s)] to [specific change].), code:block5 (Verify that [specific change] works correctly.), code:markdown (## Coordinator Synthesis) (+19 more)
...
Cohesion: 0.07
Nodes (26): rules, skills, workflows, config, policy, cliGlobalConfig, suiteGlobalConfig, workspaceConfig (+18 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (27): path, phases, requiredCliCommands, schemaVersion, rules, skills, workflows, config (+19 more)
...
Cohesion: 0.08
Nodes (25): Agent Selection Matrix, Available Agents (20 total), ⏸️ CHECKPOINT: User Approval, code:block1 (After {task-slug}.md is complete, ASK:), code:block2 (□ Security     → security-auditor, penetration-tester), code:block3 (Use the project-planner agent to create {task-slug}.md), code:block4 (Invoke agents in PARALLEL:), code:block5 (Use the project-planner agent to create {task-slug}.md:) (+17 more)

### Community 52 - "Community 52"
Cohesion: 0.14
Nodes (15): main(), CheckResult, CheckSpec, _command_for(), Console, _decode_timeout(), execute_suite(), locate_toolkit_root() (+7 more)
...
Cohesion: 0.08
Nodes (24): Anti-Patterns (AVOID), Brainstorming & Communication Protocol, code:block1 (0. CHECK MEMORY — Does .agents/memory/MEMORY.md exist?), code:block2 (1. Parse request → Extract domain, features, scale indicator), code:markdown (### [PRIORITY] **[DECISION POINT]**), code:block4 (1. Acknowledge the error), code:block5 (1. Success confirmation (celebrate briefly)), Communication Principles (+16 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (23): Anti-Patterns, Bundle Size, Caching, code:block1 (What's slow?), Core Philosophy, Core Web Vitals Targets, CSS, Images (+15 more)
...
Cohesion: 0.15
Nodes (11): main(), PerformanceChecker, Check if large components use dynamic imports (Section 2), Check for data fetching in useEffect (Section 4), Check for missing React.memo, useMemo, useCallback (Section 5), Check for unoptimized images (Section 6), Generate final report, Prefer actual React source roots over generated or unrelated files. (+3 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (22): code:yaml (max_active_agents: <bounded count>), code:text (Agent:), code:text (explorer-agent       -> code map), code:text (project-planner -> approved task graph), code:text (database-architect -> backend-specialist -> frontend-special), code:text (security-auditor -> approval checkpoint -> authorized implem), code:markdown (## Orchestration synthesis), Core principles (+14 more)

### Community 63 - "Community 63"
Cohesion: 0.09
Nodes (21): additionalProperties, $id, enum, type, properties, phases, requiredCliCommands, runtime (+13 more)

### Community 64 - "Community 64"
Cohesion: 0.09
Nodes (21): 1. README Structure, 2. API Documentation Structure, 3. Code Comment Guidelines, 4. Changelog Template (Keep a Changelog), 5. Architecture Decision Record (ADR), 6. AI-Friendly Documentation, 7. Structure Principles, code:markdown (# Project Name) (+13 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (21): 10. Props, 11. Anti "god component", 12. Tailwind class hygiene, 13. TypeScript, 14. Minimum testing, 15. Accessibility floor, 1. Separation of Concerns — the core rule, 2. File Responsibility & Size (+13 more)
...
Cohesion: 0.09
Nodes (21): 10. Review checklist, 1. Stable baseline and compatibility, 2. Architecture, 3. Transports and authentication, 4. Schema design and validation, 5. Tool, resource, and prompt design, 6. Security requirements, 7. Extensions (+13 more)
...
Cohesion: 0.10
Nodes (20): AG Kit Runtime Scripts, `auto_preview.py`, `checklist.py`, code:bash (python .agents/scripts/validate_kit.py), code:bash (python .agents/scripts/generate_manifest.py), code:bash (python .agents/scripts/dependency_graph.py), code:bash (python .agents/scripts/checklist.py .), code:bash (python .agents/scripts/verify_all.py . --no-runtime) (+12 more)

### Community 72 - "Community 72"
Cohesion: 0.10
Nodes (20): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+12 more)
...
Cohesion: 0.10
Nodes (19): additionalProperties, pattern, type, additionalProperties, type, $id, type, pattern (+11 more)
...
Cohesion: 0.11
Nodes (18): Architecture, code:block1 (.agents/memory/), code:markdown (# Memory Index), code:markdown (---), code:block4 (1. Check: Does `.agents/memory/MEMORY.md` exist?), MEMORY.md Index Format, Memory System — Persistent Cross-Session Memory, Memory Taxonomy (+10 more)
...
Cohesion: 0.11
Nodes (17): 1. Skill Meta, 2.1 Swiss Industrial Print, 2.2 Tactical Telemetry & CRT Terminal, 2. Visual Archetypes, 3.1 Macro-Typography (Structural Headers), 3.2 Micro-Typography (Data & Telemetry), 3.3 Textural Contrast (Artistic Disruption), 3. Typographic Architecture (+9 more)
...
Cohesion: 0.11
Nodes (17): 1. Small, Focused Tasks, 2. Clear Verification, 3. Logical Ordering, 4. Dynamic Naming in Project Root, Best Practices (Quick Reference), code:block1 (# [Task Name]), Overview, Plan Structure (Flexible, Not Fixed!) (+9 more)

### Community 95 - "Community 95"
Cohesion: 0.11
Nodes (17): Anti-Patterns, API / Backend, CLI / Script, code:block1 (❌ Verification by inspection:  "I can see the function exist), code:block2 (- Which files were modified?), code:bash (# For Node.js projects), code:markdown (## Verification Report), Core Principle (+9 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (17): A01: Broken Access Control, A02: Security Misconfiguration, A03: Software Supply Chain Failures, A04: Cryptographic Failures, A05: Injection, A06: Insecure Design, A07: Authentication Failures, A08: Software or Data Integrity Failures (+9 more)
...
Cohesion: 0.12
Nodes (16): AG Kit — Antigravity Native Integration, Build a plugin bundle, code:bash (node .agents/hooks/antigravity-doctor.mjs), code:json ({), code:bash (node .agents/hooks/sync-mcp.mjs --check), code:bash (node .agents/hooks/sync-mcp.mjs --apply --target suite), code:bash (node .agents/hooks/build-plugin.mjs), code:bash (agy plugin install ./dist/antigravity-plugin) (+8 more)

### Community 101 - "Community 101"
Cohesion: 0.12
Nodes (17): allowedTools, path, scripts, version, allowedTools, path, scripts, version (+9 more)

### Community 102 - "Community 102"
Cohesion: 0.12
Nodes (16): AG Kit toolkit operator guide, code:bash (npm run check:agents), code:bash (printf '%s' '{"tool_args":{"CommandLine":"rm -rf /"}}' \), code:bash (node .agents/hooks/sync-mcp.mjs --check), code:bash (npm run build:antigravity-plugin), code:bash (python .agents/scripts/checklist.py .), code:bash (python .agents/scripts/verify_all.py . --url http://localhos), code:bash (npm run generate:agents) (+8 more)

### Community 103 - "Community 103"
Cohesion: 0.12
Nodes (16): additionalProperties, description, type, $id, pattern, type, properties, description (+8 more)

### Community 104 - "Community 104"
Cohesion: 0.12
Nodes (16): AI & LLM Review Patterns, Anti-Patterns to Flag, Code Quality, Code Review Checklist, code:markdown (// ❌ Vague prompt in code), code:typescript (// ❌ Magic numbers), code:block3 (// Blocking issues use 🔴), Correctness (+8 more)
...
Cohesion: 0.12
Nodes (15): 2026.7.12, 2026.7.18, 2026.7.26, 2026.8.31, Added, Added, Added, AG Kit Toolkit Changelog (+7 more)

### Community 111 - "Community 111"
Cohesion: 0.12
Nodes (15): additionalProperties, format, type, $id, properties, created, type, updated (+7 more)
...
Cohesion: 0.26
Nodes (15): _generic_code_without_strings(), _is_placeholder(), _iter_files(), _looks_like_web_project(), main(), _new_result(), _python_code_without_strings(), _redact() (+7 more)
...
Cohesion: 0.13
Nodes (14): Agent selection, code:text (Goal:), code:markdown (## Orchestration result), Conflict resolution, Delegation contract, Execution budget and stop conditions, Final response contract, Isolation and ownership (+6 more)
...
Cohesion: 0.13
Nodes (14): actions, backupDir, conflicts, createdAt, preserved, runId, schemaVersion, strategy (+6 more)
...
Cohesion: 0.13
Nodes (14): Best Practices, code:block1 (project-name/), code:bash (npx nuxi@latest init my-app), code:bash (npm install @pinia/nuxt @prisma/client zod), code:bash (npm install tailwindcss @tailwindcss/vite), code:ts (import tailwindcss from '@tailwindcss/vite'), code:css (@import "tailwindcss";), code:bash (npm run dev) (+6 more)
...
Cohesion: 0.14
Nodes (13): 1. File structure, 2. Token schema (YAML front matter), 3. Type system, 4. Sections (canonical order), 5. Recommended token names (guidance, not required), 6. Consumer behavior for unknown content, 7. Minimal example, code:block1 (---) (+5 more)

### Community 133 - "Community 133"
Cohesion: 0.14
Nodes (13): code:block1 (/preview           - Show current status), code:block2 (/preview start), code:block3 (/preview), code:block4 (/preview start), code:bash (python .agents/scripts/auto_preview.py start [port]), Commands, Port Conflict, /preview - Preview Management (+5 more)
...
Cohesion: 0.15
Nodes (12): Best Practices (Updated), code:block1 (project-name/), code:bash (npx create-expo-app@latest my-app --template default), code:bash (npx expo install expo-router react-native-safe-area-context ), code:bash (npm install nativewind@next tailwindcss react-native-reanima), code:bash (npx expo start -c), Directory Structure, Key Packages & Purpose (+4 more)

### Community 136 - "Community 136"
Cohesion: 0.15
Nodes (12): code:block1 (What triggers this workflow? (user says X, file type Y, doma), code:markdown (---), code:block3 (.agents/skills/[skill-name]/SKILL.md), Naming Conventions, Quality Checklist, Skill Creation Protocol, Skillify — Auto-Create Skills from Workflows, Step 1: Identify the Pattern (+4 more)
...
Cohesion: 0.17
Nodes (11): AI & LLM Platforms, Automotive, Backend, Database & DevOps, Collection, Design & Creative Tools, Developer Tools & IDEs, E-commerce & Retail, Fintech & Crypto (+3 more)
...
Cohesion: 0.18
Nodes (10): 1.1 Skill Announcement (MANDATORY), 1. Modular Skill Loading Protocol, 2. Enforcement Protocol, code:markdown (📚 **Using skill: `@[skill-name]`...**), code:block2 (❌ WRONG: Read agent file → Start coding), Core Protocol - AG Kit, CRITICAL: AGENT & SKILL PROTOCOL (START HERE), 📁 File Dependency Awareness (+2 more)
...
Cohesion: 0.18
Nodes (10): 1. Protocol Overview, 2. Absolute Negative Constraints (Banned Elements), 3. Typographic Architecture, 4. Color Palette (Warm Monochrome + Spot Pastels), 5. Component Specifications, 6. Iconography & Imagery Directives, 7. Subtle Motion & Micro-Animations, 8. Execution Protocol (+2 more)

### Community 145 - "Community 145"
Cohesion: 0.29
Nodes (10): check_page(), find_web_pages(), is_page_file(), _lower_parts(), main(), Score a route source file without requiring article metadata on product docs., Return True only for route entry points, not layouts or components., Find public-facing route source files deterministically. (+2 more)
...
Cohesion: 0.18
Nodes (10): After Planning, code:block1 (CONTEXT:), code:block2 ([OK] Plan created: {slug}.md in project root), code:block3 (/plan e-commerce site with cart), 🔴 CRITICAL RULES, Expected Output, Naming Examples, /plan - Project Planning Mode (+2 more)
...
Cohesion: 0.20
Nodes (9): Best Practices, code:block1 (project-name/), Common Commands, Directory Structure, Key Concepts, Setup Steps, Tech Stack, Turbo Tasks (turbo.json) (+1 more)
...
Cohesion: 0.40
Nodes (9): audit(), check_hardcoded_strings(), check_locale_completeness(), find_locale_files(), flatten_keys(), is_skipped(), iter_code_files(), main() (+1 more)
...
Cohesion: 0.22
Nodes (8): ⚠️ AGENT ROUTING CHECKLIST (MANDATORY BEFORE EVERY CODE/DESIGN RESPONSE), Auto-Selection Protocol, code:markdown (🤖 **Applying knowledge of `@[agent-name]`...**), 🎭 Gemini Mode Mapping, 🤖 INTELLIGENT AGENT ROUTING (STEP 2 - AUTO), 📥 REQUEST CLASSIFIER (STEP 1), Request Routing - AG Kit, Response Format (MANDATORY)

### Community 161 - "Community 161"
Cohesion: 0.22
Nodes (8): code:block1 (Request: "add payment system"), code:block2 (1. Analyze existing project & architecture), code:block3 (1. Detect error), Error Handling, Feature Analysis, Feature Building, Iterative Enhancement Process, Recovery Strategy
...
Cohesion: 0.25
Nodes (7): code:block1 (project-name/), code:json ({), Next.js Full-Stack Structure (Next.js 16 Optimized), Path Aliases (tsconfig.json), Project Scaffolding, Structure Principles, When to Use What
...
Cohesion: 0.50
Nodes (7): _annotation_complete(), check_python_coverage(), check_typescript_coverage(), _local_tsc(), main(), _run_typescript_compilers(), _source_files()
...
Cohesion: 0.54
Nodes (7): add(), analyze(), analyze_package_json(), analyze_requirements(), iter_named_files(), main(), should_fail()
...
Cohesion: 0.29
Nodes (7): 12.A File Location, 12.B Required Frontmatter, 12.C Required Body Sections, 12.D Block-Library Discipline, 12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively), code:block4 (.agents/skills/frontend-design/blocks/), code:yaml (---)
...
Cohesion: 0.33
Nodes (5): installedAt, lastRunId, schemaVersion, toolkitVersion, updatedAt
...
Cohesion: 0.33
Nodes (6): backend-specialist, model, path, requires, tools, version

### Community 247 - "Community 247"
Cohesion: 0.33
Nodes (6): code-archaeologist, model, path, requires, tools, version

### Community 248 - "Community 248"
Cohesion: 0.33
Nodes (6): debugger, model, path, requires, tools, version

### Community 249 - "Community 249"
Cohesion: 0.33
Nodes (6): devops-engineer, model, path, requires, tools, version

### Community 250 - "Community 250"
Cohesion: 0.33
Nodes (6): documentation-writer, model, path, requires, tools, version

### Community 251 - "Community 251"
Cohesion: 0.33
Nodes (6): frontend-specialist, model, path, requires, tools, version

### Community 252 - "Community 252"
Cohesion: 0.33
Nodes (6): game-developer, model, path, requires, tools, version

### Community 253 - "Community 253"
Cohesion: 0.33
Nodes (6): mobile-developer, model, path, requires, tools, version

### Community 254 - "Community 254"
Cohesion: 0.33
Nodes (6): orchestrator, model, path, requires, tools, version

### Community 255 - "Community 255"
Cohesion: 0.33
Nodes (6): penetration-tester, model, path, requires, tools, version

### Community 256 - "Community 256"
Cohesion: 0.33
Nodes (6): performance-optimizer, model, path, requires, tools, version

### Community 257 - "Community 257"
Cohesion: 0.33
Nodes (6): product-owner, model, path, requires, tools, version

### Community 258 - "Community 258"
Cohesion: 0.33
Nodes (6): project-planner, model, path, requires, tools, version

### Community 259 - "Community 259"
Cohesion: 0.33
Nodes (6): qa-automation-engineer, model, path, requires, tools, version

### Community 260 - "Community 260"
Cohesion: 0.33
Nodes (6): security-auditor, model, path, requires, tools, version

### Community 261 - "Community 261"
Cohesion: 0.33
Nodes (6): seo-specialist, model, path, requires, tools, version

### Community 262 - "Community 262"
Cohesion: 0.33
Nodes (6): test-engineer, model, path, requires, tools, version

### Community 263 - "Community 263"
Cohesion: 0.33
Nodes (5): Code Rules (TIER 1) - AG Kit, 🏁 Final Checklist Protocol, 🛑 GLOBAL SOCRATIC GATE, 🏁 Plan Mode (4-Phase), 📱 Project Type Routing

### Community 264 - "Community 264"
Cohesion: 0.33
Nodes (5): API Style Selection, code:block1 (Who are the API consumers?), Comparison, Decision Tree, Selection Questions
...
Cohesion: 0.33
Nodes (5): code:block1 (1. Tokenize user request), Conflict Resolution, Detection Process, Keyword Matrix, Project Type Detection

### Community 268 - "Community 268"
Cohesion: 0.33
Nodes (5): AI Application Pattern (2026 Standard), Alternative Options, code:yaml (Frontend:), Default Stack (Web App - 2026), Tech Stack Selection (2026)
...
Cohesion: 0.33
Nodes (5): code:block1 (What are your requirements?), Comparison, Database Selection, Decision Tree, Questions to Ask
...
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, api-patterns

### Community 300 - "Community 300"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, app-builder

### Community 301 - "Community 301"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, bash-linux

### Community 302 - "Community 302"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, batch-operations

### Community 303 - "Community 303"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, brainstorming

### Community 304 - "Community 304"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, clean-code

### Community 305 - "Community 305"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, code-review-checklist

### Community 306 - "Community 306"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, code-review-graph

### Community 307 - "Community 307"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, context-compression

### Community 308 - "Community 308"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, database-design

### Community 309 - "Community 309"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, deployment-procedures

### Community 310 - "Community 310"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, design-spec

### Community 311 - "Community 311"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, frontend-architecture

### Community 312 - "Community 312"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, frontend-design

### Community 313 - "Community 313"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, game-development

### Community 314 - "Community 314"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, geo-fundamentals

### Community 315 - "Community 315"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, i18n-localization

### Community 316 - "Community 316"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, intelligent-routing

### Community 317 - "Community 317"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, lint-and-validate

### Community 318 - "Community 318"
Cohesion: 0.40
Nodes (4): kitVersion, manifestSha256, $schema, schemaVersion

### Community 319 - "Community 319"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, memory-system

### Community 320 - "Community 320"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, mobile-design

### Community 321 - "Community 321"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, nextjs-react-expert

### Community 322 - "Community 322"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, parallel-agents

### Community 323 - "Community 323"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, performance-profiling

### Community 324 - "Community 324"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, plan-writing

### Community 325 - "Community 325"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, powershell-windows

### Community 326 - "Community 326"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, python-patterns

### Community 327 - "Community 327"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, red-team-tactics

### Community 328 - "Community 328"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, rust-pro

### Community 329 - "Community 329"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, seo-fundamentals

### Community 330 - "Community 330"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, server-management

### Community 331 - "Community 331"
Cohesion: 0.40
Nodes (5): allowedTools, path, scripts, version, simplify-code

### Community 332 - "Community 332"
Cohesion: 0.40
Nodes (5): systematic-debugging, allowedTools, path, scripts, version

### Community 333 - "Community 333"
Cohesion: 0.40
Nodes (4): args, command, mcpServers, context7
...
Cohesion: 0.40
Nodes (4): code:block1 (What's the context?), Comparison, Decision Tree, ORM Selection

### Community 339 - "Community 339"
Cohesion: 0.70
Nodes (4): check_accessibility(), find_html_files(), main(), _opening_tags()
...
Cohesion: 0.80
Nodes (4): analyze(), human_bytes(), main(), should_fail()
...
Cohesion: 0.40
Nodes (5): 1. Framework Selection, code:block1 (What are you building?), Comparison Principles, Decision Tree, Selection Questions to Ask:
...
Cohesion: 0.40
Nodes (5): 5. Django Principles, code:block10 (Model design:), code:block9 (Django supports async:), Django Async (Django 5.0+), Django Best Practices
...
Cohesion: 0.50
Nodes (3): createdAt, schemaVersion, source
...
Cohesion: 0.50
Nodes (3): AG Kit Dependency Graph, code:mermaid (flowchart LR), Contracts

### Community 364 - "Community 364"
Cohesion: 0.50
Nodes (3): enabled, PreToolUse, $schema

### Community 365 - "Community 365"
Cohesion: 0.50
Nodes (3): Git Workflow, Project Conventions, Supported AI platforms (AG Kit)

### Community 366 - "Community 366"
Cohesion: 0.50
Nodes (3): Agents & Skills, Key Scripts, Quick Reference - AG Kit

### Community 367 - "Community 367"
Cohesion: 0.50
Nodes (3): 🧹 Clean Code (Global Mandatory), 🌐 Language Handling, Universal Rules (TIER 0) - AG Kit
...
Cohesion: 0.50
Nodes (4): Integration with Existing Workflows, With /orchestrate Command, With Socratic Gate, With Workspace Rules

### Community 375 - "Community 375"
Cohesion: 0.50
Nodes (4): 6. Error Handling for Mobile, code:json ({), Error Categories, Mobile-Specific Error Format
...
## Knowledge Gaps
- **3845 isolated node(s):** `pid`, `start_src`, `start_time`, `port`, `key` (+3840 more)
...
- **Why does `skills` connect `Community 40` to `Community 38`, `Community 299`, `Community 300`, `Community 301`, `Community 302`, `Community 303`, `Community 304`, `Community 305`, `Community 306`, `Community 307`, `Community 308`, `Community 309`, `Community 310`, `Community 311`, `Community 312`, `Community 313`, `Community 314`, `Community 315`, `Community 316`, `Community 317`, `Community 319`, `Community 320`, `Community 321`, `Community 322`, `Community 323`, `Community 324`, `Community 325`, `Community 326`, `Community 327`, `Community 328`, `Community 329`, `Community 330`, `Community 331`, `Community 332`, `Community 101`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `files` connect `Community 14` to `Community 244`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `components` connect `Community 15` to `Community 318`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
